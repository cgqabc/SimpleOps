...
class AddUserForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'username': forms.TextInput(attrs={'class': 'form-control','style': 'width:450px;'}),
            'password': forms.PasswordInput(attrs={'class': 'form-control','style': 'width:450px;'}),
            'email': forms.TextInput(attrs={'class': ' form-control','style': 'width:450px;'}),
            'role': forms.Select(attrs={'class': 'form-control','style': 'width:450px;'}),
            'is_active': forms.Select(choices=((True, u'启用'), (False, u'禁用')), attrs={'class': 'form-control','style': 'width:450px;'}),
        }
...
class RolueGroupsForm(forms.ModelForm):
    class Meta:
        model = RolueGroups
        exclude = ("id",)
        widgets = {
    ...
    def __init__(self, *args, **kwargs):
        super(RolueGroupsForm, self).__init__(*args, **kwargs)
