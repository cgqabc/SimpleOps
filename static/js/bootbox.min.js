!(function(t, e) {
  ...
  function u(t) {
    ...
    return (
      ...
      s(o, function(t, n, r) {
        if (
          (e.isFunction(n) && (n = o[t] = { callback: n }),
          "object" !== e.type(n))
        )
        ...
        n.label || (n.label = t),
          n.className ||
            (n.className =
              2 >= a && r === a - 1 ? "btn-primary" : "btn-default");
      }),
      t
    );
  }
  ...
  function d(t, e, o, a) {
    var n = { className: "bootbox-" + t, buttons: b.apply(null, e) };
    return m(p(n, a, o), e);
  }
  function b() {
  ...
  (r.defineLocale = function(t, e) {
    return e
      ? ((C[t] = { OK: e.OK, CANCEL: e.CANCEL, CONFIRM: e.CONFIRM }), C[t])
      : (delete C[t], null);
  }),
    (r.alert = function() {
      var t;
      if (
        ((t = d("alert", ["ok"], ["message", "callback"], arguments)),
        t.callback && !e.isFunction(t.callback))
      )
        throw new Error(
    ...
    (r.prompt = function() {
      ...
      if (
        ...
        (t = m(p(n, arguments, ["title", "callback"]), ["cancel", "confirm"])),
        (u = t.show === o ? !0 : t.show),
        (t.message = l),
        (t.buttons.cancel.callback = t.onEscape = function() {
      ...
      switch (((c = e(a.inputs[t.inputType])), t.inputType)) {
        ...
        case "select":
          ...
          s(f, function(t, a) {
            ...
            a.group &&
              (d[a.group] ||
                (d[a.group] = e("<optgroup/>").attr("label", a.group)),
              (n = d[a.group])),
              n.append(
      ...
      return (
        t.placeholder && c.attr("placeholder", t.placeholder),
        t.pattern && c.attr("pattern", t.pattern),
        l.append(c),
        l.on("submit", function(t) {
          t.preventDefault(),
            t.stopPropagation(),
            i.find(".btn-primary").click();
        }),
        (i = r.dialog(t)),
        i.off("shown.bs.modal"),
    ...
    (r.dialog = function(t) {
      ...
      if (
        ...
        i.find(".bootbox-body").html(t.message),
        t.animate === !0 && "fade" == t.animateIn
          ? n.addClass("fade")
          : t.animate === !0 &&
            t.animateIn &&
            "fade" != t.animateIn &&
            r.addClass("animated " + t.animateIn),
        t.className && n.addClass(t.className),
        "large" === t.size && r.addClass("modal-lg"),
        "small" === t.size && r.addClass("modal-sm"),
        t.title && i.before(a.header),
        t.closeButton)
      ) {
        var d = e(a.closeButton);
        t.title
          ? n.find(".modal-header").prepend(d)
          : d.css("margin-top", "-10px").prependTo(i);
      }
      t.title && n.find(".modal-title").html(t.title),
        f.length && (i.after(a.footer), n.find(".modal-footer").html(f));
      var b = function() {
      ...
      return (
        n.on("hide.bs.modal", function() {
          return n.hasClass("in") && !n.hasClass("fade")
            ? (n
                .removeClass("in")
                .on(
              ...
              t.animate === !0 &&
                t.animateOut &&
                "fade" != t.animateOut &&
                r.addClass("animated " + t.animateOut),
              !1)
            : !0;
        }),
        ...
        e(t.container).append(n),
        n.modal({ backdrop: t.backdrop, keyboard: !1, show: !1 }),
        t.show && n.modal("show"),
        n
      );
    }),
